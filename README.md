...
* Watch Japanese content with readable subtitles
* Improve pronunciation
* Learn faster using real media
* Practice listening + reading together

The goal of this project is to make Japanese learning easier for beginners by providing a simple tool to convert subtitles into Romaji.
